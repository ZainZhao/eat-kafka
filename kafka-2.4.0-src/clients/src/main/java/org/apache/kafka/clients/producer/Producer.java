...
public interface Producer<K, V> extends Closeable {
     ...
     * 发送消息，实际是将消息放入 RecordAccumulator 暂存，等待发送
     *
     */
     ...
     * 刷新操作，等待 RecordAccumulator 中所有消息发送完成，在刷新完成之前会阻塞调用的线程
     */
    void flush();

    /**
     * See {@link KafkaProducer#partitionsFor(String)}
     * 从 Metedata 中获取指定 Topic 中的分区信息
     */
     ...
     * 等待 RecordAccumulator 中的消息清空，关闭 Sender 线程
     */
